...
from dslabs_functions import plot_bar_chart, plot_multibar_chart, CLASS_EVAL_METRICS, run_KNN, run_NB

# Carregar os dados
filename = "datasets/1_1_4_scaling_class_ny_arrests.csv"
subject = " [ny arrests]"
file_tag = "2_4_balancing_1_ny_arrests"
file_output_TRAIN = "datasets/1_1_5_balancing_TRAIN_class_ny_arrests.csv"
file_output_TEST = "datasets/1_1_5_balancing_TEST_class_ny_arrests.csv"
