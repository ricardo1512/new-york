...
savefig(f"images/B/ME_LSTMs/1_LSTMs_{measure}_study_MULTI.png")
...
savefig(f"images/B/ME_LSTMs/1_LSTMs_{measure}_eval_MULTI.png")
...
savefig(f"images/B/ME_LSTMs/1_LSTMs_{measure}_forecast_MULTI.png")
