...
target = "Manhattan"  # Série alvo
exog_columns = ["Bronx", "Brooklyn", "Queens", "StatenIsland"]
...
savefig(f"images/B/ME_ARIMA/1_ARIMA_plot_diagnostics_MULTI.png", bbox_inches="tight")
...
savefig(f"images/B/ME_ARIMA/1_ARIMA_{measure}_study_MULTI.png", bbox_inches="tight")
...
savefig(f"images/B/ME_ARIMA/1_ARIMA_{measure}_eval_MULTI.png")

plot_forecasting_series(
    train, test, prd_tst, title=f"ARIMA " + subject, xlabel=timecol, ylabel=target
)
savefig(f"images/B/ME_ARIMA/1_ARIMA_{measure}_forecast_MULTI.png")