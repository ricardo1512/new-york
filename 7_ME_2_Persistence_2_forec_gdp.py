...
savefig(f"images/B/ME_Persistence/2_persistence_optim_eval.png", bbox_inches="tight")
...
savefig(f"images/B/ME_Persistence/2_persistence_optim_forecast.png", bbox_inches="tight")
...
savefig(f"images/B/ME_Persistence/2_persistence_realist_eval.png", bbox_inches="tight")
...
savefig(f"images/B/ME_Persistence/2_persistence_realist_forecast.png", bbox_inches="tight")