...
savefig(f"images/B/ME_ARIMA/1_ARIMA_plot_diagnostics_UNI.png", bbox_inches="tight")
...
savefig(f"images/B/ME_ARIMA/1_ARIMA_{measure}_study_UNI.png", bbox_inches="tight")
...
savefig(f"images/B/ME_ARIMA/1_ARIMA_{measure}_eval_UNI.png")
...
savefig(f"images/B/ME_ARIMA/1_ARIMA_{measure}_forecast_UNI.png")