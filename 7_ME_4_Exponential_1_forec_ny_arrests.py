...
savefig(f"images/B/ME_ExponentialSmoothing/1_exponential_smoothing_{measure}_study.png", bbox_inches="tight")
...
savefig(f"images/B/ME_ExponentialSmoothing/1_exponential_smoothing_{measure}_eval.png", bbox_inches="tight")
...
savefig(f"images/B/ME_ExponentialSmoothing/1_exponential_smoothing_{measure}_forecast.png", bbox_inches="tight")