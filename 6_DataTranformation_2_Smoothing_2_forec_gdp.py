...
filename = "datasets/2_1_aggregation_forecast_gdp_europe.csv"
file_output= "datasets/2_2_smoothing_forecast_gdp_europe.csv"
subject = " [gdp europe]"
...
data.to_csv(file_output, index_label="Year")
