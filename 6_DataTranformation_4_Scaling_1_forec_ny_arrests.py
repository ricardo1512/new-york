...
filename = "datasets/2_3_differentiation_forecast_ny_arrests.csv"
file_output = "datasets/2_4_scaling_forecast_ny_arrests.csv"
subject = " [ny arrests]"
...
savefig(f"images/B/DT_Scaling/1_Scaling_{target}_first.png", bbox_inches="tight")

# Plotar o gráfico com os dados normalizados
plot_ts_multivariate_chart(df_minmax, title=f"{file_tag} after MinMax Scaling")
plt.savefig(f"images/B/DT_Scaling/1_Scaling_{target}_minmax_multivariate.png", bbox_inches="tight")

# Exportar o DataFrame escalado para o arquivo CSV
df_minmax.to_csv(file_output, index_label="Date")