...
savefig(f"images/B/ME_LSTMs/2_LSTMs_{measure}_study_UNI.png")
...
savefig(f"images/B/ME_LSTMs/2_LSTMs_{measure}_eval_UNI.png")
...
savefig(f"images/B/ME_LSTMs/2_LSTMs_{measure}_forecast_UNI.png")