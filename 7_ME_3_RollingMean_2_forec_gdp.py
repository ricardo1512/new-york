...
savefig(f"images/B/ME_RollingMean/2_rollingmean_{measure}_study.png", bbox_inches="tight")
...
savefig(f"images/B/ME_RollingMean/2_rollingmean_{measure}_win{params[0]}_eval.png", bbox_inches="tight")
...
savefig(f"images/B/ME_RollingMean/2_rollingmean_{measure}_forecast.png", bbox_inches="tight")