...
savefig(f"images/B/ME_SimpleAverage/2_simpleAvg_eval.png", bbox_inches="tight")
...
savefig(f"images/B/ME_SimpleAverage/2_simpleAvg_forecast.png", bbox_inches="tight")
